  ...
  return (
    <>
      ...
      <div className="flex justify-end items-center mb-2">
        {exportable && (
          <Button type="button" icon="pi pi-external-link" label="Export" onClick={exportCSV} className="bg-primary text-accent font-bold px-4 py-2 rounded hover:bg-yellow-300" />
        )}
      </div>
      <div className="overflow-x-auto">
        <DataTable
          ...
          tableClassName="min-w-full text-sm text-left text-gray-700 font-sans border-separate border-spacing-0"
          rowClassName={() => ''}
          scrollable
          scrollHeight="600px"
