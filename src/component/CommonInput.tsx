    ...
    <div className={`mb-4 ${className}`}>
        ...
        <div className="relative">
            ...
            <input
                ...
                className={`block w-full ${icon ? 'pl-10' : 'pl-4'} pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${error ? 'border-red-500' : 'border-gray-300'
                    }`}
